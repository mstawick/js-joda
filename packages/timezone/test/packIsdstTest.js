...
describe('packIsdst', () => {
    ...
    describe('pack/ unpack', () => {
        ...
        it('should pack and unpack int array containing -1, 0 or 1', () => {
            const isdstFixtures = [
                { in: [-1, 0, 1], packed: '' },
                { in: [-2, 0, 2], packed: '', out: [-1, 0, 1] },
                { in: [0, 0, 1, -1], packed: '' },
                { in: [1, 0, 0, 1, -1], packed: '' },
                { in: [0, 1, 0, 1, 0, -1], packed: '' },
                { in: [0, 1, 0, 1, 1, 0], packed: '' },
                { in: [1, 1, 0, 1, 0, 0, -1], packed: '' },
                { in: [0, 1, 1, 0, 1, 0, 0, -1], packed: '' },
                { in: [0, 1, 1, 0, 1, 0, 0, 1], packed: '' },
                { in: [0, 1, 1, 0, 1, 0, 0, 0], packed: '' },
                { in: [0, 0, 0, 0, 1, 1, 0, 1, 0, 0, 0], packed: '' },
                { in: [1, 0, 0, 0, 0, 1, 1, 0, 1, 0, 0, 0], packed: '' },
            ];
